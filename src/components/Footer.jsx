                ...
                <div className="grid md:grid-cols-4 gap-8">
                    <div className="footer-company">
                        ...
                        <p className="mb-6 text-gray-300">
                            Transforming businesses through technology excellence since 2025. Your trusted partner for IT consulting and staffing solutions.
                        </p>
                        <div className="social-icons flex gap-3">
                            <a href="https://www.linkedin.com" className="social-icon w-8 h-8 rounded-full bg-gray-700 flex items-center justify-center">
                                <div className="text-sm font-bold">in</div>
                            </a>
                            <a href="https://www.twitter.com" className="social-icon w-8 h-8 rounded-full bg-gray-700 flex items-center justify-center">
                                <div className="text-sm font-bold">X</div>
                            </a>
                            <a href="https://www.facebook.com" className="social-icon w-8 h-8 rounded-full bg-gray-700 flex items-center justify-center">
                                <div className="text-sm font-bold">f</div>
                            </a>
                            <a href="https://www.instagram.com" className="social-icon w-8 h-8 rounded-full bg-gray-700 flex items-center justify-center">
                    ...
                    <div className="footer-links">
                        ...
                        <ul className="space-y-3">
                            ...
                            <li>
                                <Link to="/services/it-consulting" className="text-gray-300 hover:text-white flex items-center">
                                    <ChevronRight size={16} className="mr-2" /> IT Consulting
                                </Link>
                            </li>
                            <li>
                                <Link to="/services/it-staffing" className="text-gray-300 hover:text-white flex items-center">
                    ...
                    <div className="footer-services">
                        ...
                        <ul className="space-y-3">
                            ...
                            <li>
                                <Link to="/services/it-staffing" className="text-gray-300 hover:text-white flex items-center">
                                    <ChevronRight size={16} className="mr-2" /> Software Development
                                </Link>
                            </li>
                            <li>
                                <Link to="/services/it-consulting" className="text-gray-300 hover:text-white flex items-center">
