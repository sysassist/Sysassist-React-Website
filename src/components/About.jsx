...
const About = () => {
    ...
    const coreValues = [
        { title: 'Excellence', description: 'We strive for excellence in every project and engagement.' },
        { title: 'Innovation', description: 'We embrace cutting-edge technologies and methodologies.' },
        { title: 'Integrity', description: 'We operate with transparency and ethical standards.' },
    ...
    return (
        <section id="about" className="py-25 bg-gradient-to-br from-white via-blue-50 to-cyan-100">
            <div className="container mx-auto px-4">
                ...
                <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
                    ...
                    <motion.div
                        ...
                        variants={sectionVariants}
                    >
                        <h2 className="text-4xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-cyan-600">About SysAssist</h2>
                        <p className="text-lg text-gray-700 mb-6">
                            SysAssist is a premier IT consulting and staffing firm dedicated to delivering innovative technology solutions that drive business success. Our team of experienced professionals works closely with clients to understand their unique challenges and develop tailored strategies for growth.
                        </p>
                            ...
                            <ul className="space-y-3">
                                {coreValues.map((value, index) => (
                                    <li key={index} className="flex items-start gap-3">
                                        <span className="text-blue-600 mt-1"><CheckCircle size={18} /></span>
                ...
                <div className="directors mb-16">
                    <h2 className="text-3xl font-bold text-center mb-10 text-blue-700">Our Directors</h2>
                    <div className="grid md:grid-cols-2 gap-8">
                        {[{
                            ...
                            <motion.div
                                ...
                                variants={sectionVariants}
                            >
                                <img src={director.image} alt={director.name} className="w-24 h-24 rounded-full object-cover shadow-md" />
                                <div>
                                    <h3 className="text-xl font-bold text-blue-700 mb-2">{director.name}</h3>
                                    <p className="text-gray-700 text-sm">{director.description}</p>
                                </div>
                            </motion.div>
                        ))}
                    </div>
                    ...
                    <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
                        {teamMembers.map((member, idx) => (
                            <motion.div
                                ...
                                variants={sectionVariants}
                            >
                                <img src={member.image} alt={member.name} className="w-20 h-20 mx-auto rounded-full object-cover mb-4" />
