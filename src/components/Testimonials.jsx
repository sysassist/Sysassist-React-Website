...
const Testimonials = () => {
  ...
  return (
    <section id="testimonials" className="py-20 bg-gradient-to-br from-white via-blue-50 to-cyan-100">
          ...
          <div className="testimonial-container overflow-hidden">
            ...
            >
              {testimonials.map((testimonial) => (
                <div key={testimonial.id} className="testimonial-card min-w-full">
                  <motion.div
          ...
          <div className="testimonial-indicators flex justify-center mt-8 gap-2">
            {testimonials.map((_, index) => (
              <button
                ...
                className={`indicator-dot w-3 h-3 rounded-full ${activeIndex === index ? 'bg-blue-600' : 'bg-gray-300'} transition-all duration-300`}
