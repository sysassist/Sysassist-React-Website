...
const Clients = () => {
    ...
    const industries = [
        { title: "Financial Services", description: "Secure solutions for banks, insurance, and fintech" },
        { title: "Healthcare", description: "HIPAA-compliant systems for medical providers" },
        { title: "E-Commerce", description: "Scalable platforms for online retailers" },
        { title: "Manufacturing", description: "Automation and ERP for production efficiency" },
        ...
        { title: "Real Estate", description: "Property management and client portals" },
        { title: "Non-Profit", description: "Cost-effective solutions for organizations" }
    ];

    return (
        <section id="clients" className="py-20 bg-gradient-to-br from-white via-blue-50 to-cyan-100">
            <div className="container mx-auto px-4">
                <div className="text-center mb-16">
                    ...
                    >
                        We're proud to showcase our partnership with industry leaders who trust our IT solutions.
                    </motion.p>
                </div>
                        ...
                        <div className="grid md:grid-cols-2 gap-10">
                            ...
                            <div className="relative h-64 md:h-full">
                                ...
                                <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex items-end">
                                    <div className="p-6 text-white">
                                        <h3 className="text-3xl font-semibold tracking-tight">{clientDetails.name}</h3>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="p-8 flex flex-col justify-center">
                                ...
                                <div className="flex items-center">
                                    ...
                                    <div>
                                        <h4 className="text-xl font-bold">{clientDetails.directorName}</h4>
                                        <p className="text-gray-500">{clientDetails.directorTitle}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div className="industries mt-20">
                    <h3 className="text-2xl font-bold mb-10 text-center text-gray-800">Industries We Serve</h3>
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                        {industries.map((industry, index) => (
                            <motion.div
                                key={index}
                                className="industry-card p-6 bg-white rounded-lg shadow-lg hover:shadow-xl transition-all duration-300"
                                whileHover={{ scale: 1.05 }}
                                transition={{ type: 'spring', stiffness: 300 }}
                            >
                                <h4 className="text-lg font-semibold mb-2 text-gray-800">{industry.title}</h4>
