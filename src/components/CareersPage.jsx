    ...
    return (
        <div className="careers-page">
            ...
            <div className="careers-hero relative bg-gray-900 text-cyan-600">
                ...
                <img src="/api/placeholder/1200/400" alt="Careers at SysAssist" className="w-full h-full object-cover absolute mix-blend-overlay" />
                <div className="container mx-auto px-4 py-24 relative z-10">
                    <div className="max-w-3xl">
                        <h1 className="text-4xl md:text-5xl font-bold mb-4">Join Our Team</h1>
                        <p className="text-xl text-gray-600">
                            Build your career with SysAssist and work on innovative technology solutions that make a difference.
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div className="container mx-auto px-4">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                            At SysAssist, we're more than just a workplace. We're a community of innovators, problem-solvers, and technology enthusiasts.
                        </p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        <div className="benefit-card text-center p-6 rounded-xl bg-gray-50">
                            ...
                            <p className="text-gray-600">
                                Work on challenging projects using cutting-edge technologies to solve real-world problems for our clients.
                            </p>
                        </div>
                        ...
                        <div className="benefit-card text-center p-6 rounded-xl bg-gray-50">
                            ...
                            <p className="text-gray-600">
                                Join a diverse team that values collaboration, continuous learning, and mutual respect.
                            </p>
                        </div>
                        ...
                        <div className="benefit-card text-center p-6 rounded-xl bg-gray-50">
                            ...
                            <p className="text-gray-600">
                                Develop your skills and advance your career with our professional development programs and mentorship.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <section className="py-16 bg-gray-50">
                <div className="container mx-auto px-4">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                            Explore our open positions and find the perfect role to match your skills and career goals.
                        </p>
                    </div>
                    ...
                    <div className="job-listings">
                        {filteredJobs.length > 0 ? (
                            filteredJobs.map(job => (
                                <div key={job.id} className="job-card bg-white rounded-xl shadow-md overflow-hidden mb-6">
                                    <div
                                        ...
                                        <div>
                                            ...
                                            <div className="flex flex-wrap gap-4 mt-2 text-gray-600">
                                                <span className="flex items-center">
                                                    <Briefcase size={16} className="mr-1" /> {job.location}
                                                </span>
                                                <span className="flex items-center">
                                                    <Briefcase size={16} className="mr-1" /> {job.type}
                                                </span>
                                                <span className="flex items-center">
                                                    <Briefcase size={16} className="mr-1" /> Posted: {new Date(job.postedDate).toLocaleDateString()}
                                                </span>
                                            </div>
                                        </div>
                                        <ChevronDown
                                            size={24}
                                            className={`transform transition-transform ${expandedJob === job.id ? 'rotate-180' : ''}`}
                                        />
                                    </div>
                            ...
                            <div className="no-jobs-found bg-white p-8 rounded-xl text-center">
                                ...
                                <p className="text-gray-600">
                                    We couldn't find any positions matching your criteria. Please try adjusting your search.
                                </p>
                            </div>
                        )}
                    </div>
                    ...
                    <div className="max-w-3xl mx-auto">
                        <div className="text-center mb-8">
                            ...
                            <p className="text-lg text-gray-600">
                                Complete the form below to apply for your desired position. We'll review your application and get back to you soon.
                            </p>
                        </div>
                        ...
                        {formSubmitted ? (
                            ...
                            <form ref={formRef} onSubmit={handleSubmit} className="application-form bg-gray-50 rounded-xl p-8">
                                    ...
                                    <div className="form-group">
                                        ...
                                        <div className="relative">
                                            ...
                                            <div className="w-full px-4 py-2 bg-white border border-gray-300 rounded-lg text-gray-500 flex items-center justify-between">
                                                <span>{applicationForm.resume ? applicationForm.resume.name : "Upload your resume (PDF or DOCX)"}</span>
                                                <Briefcase size={20} />
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="form-group mt-6">
                                    <label htmlFor="message" className="block text-gray-700 font-medium mb-2">Cover Letter / Additional Information</label>
                                    <textarea
                                        id="message"
                                        name="message"
                                        rows="5"
                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-3xl mx-auto text-center">
                        ...
                        <p className="text-xl text-gray-600 mb-8">
                            Can't find the right position? Connect with us on social media to stay updated on future opportunities.
                        </p>
                        <div className="social-links flex justify-center space-x-4">
                            <a href="#" className="social-link bg-white text-blue-900 w-12 h-12 rounded-full flex items-center justify-center hover:bg-blue-100 transition-colors">
